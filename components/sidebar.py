...
from .interface.content import BicuContent, HelpContent, HistoryContent, ConsumersContent, SettingsContent, ReportsContent, BalanceContent
...
class SideBar(QWidget):
    ...
    def initUI(self):
        ...
        self.history_btn = SideaBarButton(name="История операций", icon="./components/images/qicon.png")
        ...
        self.right_widget.setStyleSheet("QTabWidget {border:1px solid #000000; border-radius: 10px;}")
