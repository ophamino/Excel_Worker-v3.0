...
class BypassCard(ContentCard):
    def __init__(self, parent: QWidget | None = None) -> None:
        super(BypassCard, self).__init__(parent)
        
        label = CardTitle("Обходной лист", self)
        button = BypassButton(self)
...
class ASCUECard(ContentCard):
    def __init__(self, parent: QWidget | None = None) -> None:
        super(ASCUECard, self).__init__(parent)
        label = CardTitle("Расчетная ведомость АСКУЭ", self)
        button = ASCUEButton(self)
